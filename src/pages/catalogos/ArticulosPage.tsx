...
const formFields = [
  ...
  { key: 'ultimo_costo', label: 'Últ. costo compra', type: 'number' as const },
  { key: 'costo_promedio', label: 'Costo compra prom.', type: 'number' as const },
]
...
export function ArticulosPage() {
  ...
  const columns = [
    ...
    { key: 'ultimo_costo', label: 'Últ. Costo', render: (v: any) => fmt(v), editable: true,
      renderEdit: (v: any, _: any, onChange: any) => (
        <input type="number" step="0.01" defaultValue={v} onChange={(e) => onChange(Number(e.target.value))} className="w-24 rounded border border-input bg-background px-2 py-1 text-right text-xs" />
      ),
    },
    { key: 'costo_promedio', label: 'Costo Prom.', render: (v: any) => fmt(v), editable: true,
      renderEdit: (v: any, _: any, onChange: any) => (
        <input type="number" step="0.01" defaultValue={v} onChange={(e) => onChange(Number(e.target.value))} className="w-24 rounded border border-input bg-background px-2 py-1 text-right text-xs" />
      ),
    },
